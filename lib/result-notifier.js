(function() {
  ...
  ResultNotifier = (function() {
    ...
    ResultNotifier.acquired = function(lockInfo) {
      ...
      return lockInfo.callback(null, true, lockInfo.payload, function(succeeded) {
        if (succeeded) {
    ...
    ResultNotifier.oppsiteHasCompleted = function(lockInfo) {
      ...
      return lockInfo.callback(null, false, lockInfo.payload, function() {});
    };
    ...
    ResultNotifier.errorOccurred = function(error, lockInfo) {
      ...
      return lockInfo.callback(error, false, lockInfo.payload, function() {});
    };
